...
//        switch (_dim) {
//            case 3:
//                res = new JsonObject().add("z", getZ()).merge(res);
//            case 2:
//                res = new JsonObject().add("y", getY()).merge(res);
//            case 1:
//                res = new JsonObject().add("x", getX()).merge(res);
//                break;
//        }
//        return res;
//    }
...
//    public static Point fromJson(JsonObject p) {
//        Point res = new Point(0);
//        try {
//            switch (p.size()) {
//                case 3:
//                    res.define(p.get("x").asDouble(), p.get("y").asDouble(), p.get("z").asDouble());
//                    break;
//                case 2:
//                    res.define(p.get("x").asDouble(), p.get("y").asDouble());
//                    break;
//                case 1:
//                    res.define(p.get("x").asDouble());
//                    break;
//            }
//            return res;
//
