...
public class Thing extends Entity {
    ...
    protected Map2DGrayscale _surface;
    ...
    public Thing setSurface(Map2DGrayscale cartography) {
        _surface = cartography;
        return this;
    }

    public Map2DGrayscale getSurface() {
        return _surface;
    }
    ...
    public Thing placeAtSurface(Point p) {
        this.setPosition(new Point(p.getX(), p.getY(), this.getWorld().getEnvironment().getSurface().getLevel(p.getX(), p.getY())));
        return this;
    }
...
//            res.add("surface", _surface.getLevel((int) target.getX(), (int) target.getY()));
//        }
//        return res;
//    }
